...
public enum Permission {
    ...
    EXECUTE_NORMAL_COMMAND("EXECUTE_COMMAND",0),
    ...
    EXECUTE_COMMAND("EXECUTE_COMMAND_PERMISSION",3, EXECUTE_NORMAL_COMMAND,EXECUTE_CONSOLE_COMMAND,EXECUTE_ADMINISTRATOR_COMMAND,CANCEL_COMMAND_EXECUTE),
    ...
    DISABLE_PLUGIN("UNLOAD_PLUGIN",2),
    ENABLE_PLUGIN("ENABLE_PLUGIN",2),
    DISABLE_MAIN_PLUGIN("DISABLE_MAIN_PLUGIN",4),
    ENABLE_MAIN_PLUGIN("ENABLE_MAIN_PLUGIN", 4),
    ...
    ACCESS_OTHER_FILE("ACCESS_OTHER_FILE",4),

    INIT_PLUGIN("INIT_PLUGIN",4),
    ALL("ALL",5,REGISTER,BOT,MESSAGE,EVENT_SUBMIT,DISABLE_PLUGIN,ENABLE_PLUGIN,DISABLE_MAIN_PLUGIN,ENABLE_MAIN_PLUGIN,EXIT,LOAD_SOFT_DEPENDENCIES,NETWORK,SCHEDULER,GET_BOT_MANAGER,REMOVE,ACCESS_OTHER_FILE,INIT_PLUGIN);
