...
public enum Permission {
    ...
    ALL("ALL",5,REGISTER,BOT,MESSAGE,EVENT_SUBMIT,DISABLE_PLUGIN,ENABLE_PLUGIN,DISABLE_MAIN_PLUGIN,ENABLE_MAIN_PLUGIN,EXIT,LOAD_SOFT_DEPENDENCIES,NETWORK,SCHEDULER,GET_BOT_MANAGER,REMOVE,ACCESS_OTHER_FILE);
